...
for (pref in preflist){
    ...
    # TODO: BIN into 10k starting at 0 - reduce ld structure, more comparable, etc.
    # TODO: Save as is for speed. 
    # All enhancers:
    ...
    # TODO: Many random sets of the same size (within enhancers - or within SNPs?)
...
# TODO MAKE WITH node.pm AS WELL
# TODO MAKE WITH nodevenh.pm AS WELL
# pltchoice = 'snps'
