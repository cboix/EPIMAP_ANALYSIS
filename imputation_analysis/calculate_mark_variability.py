#!/usr/bin/pyton
# ------------------------------------------------------------------------
# Script to return genome-wide statistics on variabilty of genomic tracks
# ------------------------------------------------------------------------
import re
import os
import sys
...
class calculate_gw_stats(object):
    def __init__(self, mark, infofile, dir, outprefix,
                 dataset='observed', chrom=None):
        # Arguments:
        self.mark = mark
