...
INDFILE=${DML_DIR}/masterlist_DHSs_733samples_WM20180608_all_coords_hg19.txt
SORTIND=${DML_DIR}/masterlist_DHSs_733samples_WM20180608_all_coords_hg19_sorted.bed
if [[ ! -s $SORTIND ]]; then
